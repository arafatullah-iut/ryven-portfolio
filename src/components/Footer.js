      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto mb-8">
            I believe in giving back to the community. Here are some of my open
            source contributions that have helped developers worldwide.
          </p>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-gray-400 text-sm">jastin.tank@email.com</li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-800">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              © 2024 Ryven Portfolio. All rights reserved.
            </p>
